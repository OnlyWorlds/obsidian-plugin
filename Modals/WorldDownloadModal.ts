...
export class WorldDownloadModal extends Modal {
    ...
    onOpen() {
        ...
        description.innerHTML = `Enter the API key of the world you want to download and your PIN. Use an ow_ key from your account page, or a classic 10-digit key.`;
